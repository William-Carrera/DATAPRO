...
public class LinkedList<E> implements Iterable<E> {
    ...
    public E get(int index) {
    	...
    	Node copy = head; //our position in the node
    ...
    public void print() {
    	...
    	System.out.println("head "+ head.datum);
    	Node copy =head;
    	for(int i =0;i<size;i++) {
    		if(copy==null)
    			System.out.println("void");
    		else
    			System.out.println(copy.datum);
    		copy=copy.next;
    	}
    	System.out.println("tail "+ tail.datum);

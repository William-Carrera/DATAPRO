...
public abstract class SetTest extends CollectionTest{
    ...
    public void removeSomeIterator() {
        ...
        for (Iterator<String> it = testSet.iterator(); it.hasNext(); ) {
        	newtest++;
        	System.out.println(newtest + " "+it.next());
        }
        newtest=0;
        for (Iterator<String> it = testSet.iterator(); it.hasNext(); ) {
        	newtest++;
        ...
        System.out.println("size: " +newtest);
        testSet.remove(getData()[3]);
        testSet.remove(getData()[4]);
        testSet.remove(getData()[9]);
        int nnewtest=0;
        for (Iterator<String> it = testSet.iterator(); it.hasNext(); ) {
        	nnewtest++;
        	System.out.println(nnewtest + " "+it.next());
        }
        System.out.println("size: " +testSet.size());
        clearMarks();
        int test=0;
        for (Iterator<String> it = testSet.iterator(); it.hasNext(); ) {
        	...
        	marks[indexForDatum(itNext)]++;
            System.out.print(itNext + " ");
        }
        System.out.println();
        System.out.println("Msize: " +marks.length+" test: " +test);
        for (int i = 0; i < marks.length; i++) {
        	System.out.print(" M: " + marks[i] + " i: " + i);
            if (i == 3 || i == 4 || i == 9)
                assertEquals(0, marks[i]);
            else
                assertEquals(1, marks[i]);
